...
namespace FunctionalCSharp.Books.FunctionalProgrammingInCSharp.Part1_CoreConcepts.Chap1_Introduction.Functions.
    FunctionFactories
{
    public static class ConnectionHelper
    {
        ...
        public static T Connect<T>(string connString, Func<IDbConnection, T> func)
