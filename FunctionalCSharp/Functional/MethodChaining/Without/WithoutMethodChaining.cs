...
namespace FunctionalCSharp.Functional.MethodChaining.Without
{
    ...
    public static class WithoutMethodChaining
    {
        public static string GetSelectBoxWithoutMethodChaining()
        {
            ...
            var selectBox = BuildSelectBoxOld(options, "theDoctors", true);

            return selectBox;
        }

        private static string BuildSelectBoxOld(IDictionary<int, string> options, string id, bool includeUnknown)
        {
