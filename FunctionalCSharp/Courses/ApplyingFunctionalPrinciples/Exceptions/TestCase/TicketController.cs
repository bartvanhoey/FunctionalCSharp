using FunctionalCSharp.Courses.ApplyingFunctionalPrinciples.Exceptions.Errors.TicketController;
using FunctionalCSharp.Functional.ResultType;

namespace FunctionalCSharp.Courses.ApplyingFunctionalPrinciples.Exceptions.TestCase
{
